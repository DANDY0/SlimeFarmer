...
public class TutorialDeleteSlime : MonoBehaviour, Tutorial
{
    ...
    [SerializeField] private TextMeshProUGUI m_DeleteSlime;
    ...
    {
        TutorialManager.Instance.OnDeleteTutorEnabled += FadeIn;
        TutorialManager.Instance.OnDeleteTutorDisabled += FadeOut;
    }
    ...
    public void PlayAnimation()
    {
        ...
        TextSequence.Append(m_DeleteSlime.transform.DOScale(Vector3.one*1f, .3f));
        TextSequence.Append(m_DeleteSlime.transform.DOScale(Vector3.one*1.2f, .6f));
        TextSequence.Append(m_DeleteSlime.transform.DOScale(Vector3.one*1f, .3f));
